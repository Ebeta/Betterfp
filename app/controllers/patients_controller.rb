class PatientsController < ApplicationController
    ...
    def patient_params
        params.require(:patient).permit(:name, :age, :gender, :email, :contact, :contact_number, :phone_number)
        # , medications_attributes: [:name, :description, patient_medications_attributes: [:dose, :count,
